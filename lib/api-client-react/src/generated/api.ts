...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetCustomerOrdersQueryKey(customerId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getCustomerOrders>>
  > = ({ signal }) =>
    getCustomerOrders(customerId, { signal, ...requestOptions });
...
export const getResendOrderEmailMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type ResendOrderEmailMutationResult = NonNullable<
  Awaited<ReturnType<typeof resendOrderEmail>>
>;
...
export const getGetTrackingEventsQueryKey = (orderId: string) => {
  return [`/api/orders/${orderId}/tracking-events`] as const;
};

export const getGetTrackingEventsQueryOptions = <
  TData = Awaited<ReturnType<typeof getTrackingEvents>>,
  TError = ErrorType<unknown>,
>(
  orderId: string,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getTrackingEvents>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetTrackingEventsQueryKey(orderId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getTrackingEvents>>
  > = ({ signal }) => getTrackingEvents(orderId, { signal, ...requestOptions });
...
export type GetTrackingEventsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getTrackingEvents>>
>;
...
export function useGetTrackingEvents<
  TData = Awaited<ReturnType<typeof getTrackingEvents>>,
  TError = ErrorType<unknown>,
>(
  orderId: string,
...
export const getEmailNotifications = async (
  ...
  return customFetch<EmailNotification[]>(
    getGetEmailNotificationsUrl(orderId),
    {
      ...options,
      method: "GET",
    },
...
export const getGetEmailNotificationsQueryKey = (orderId: string) => {
  return [`/api/orders/${orderId}/email-notifications`] as const;
};

export const getGetEmailNotificationsQueryOptions = <
  TData = Awaited<ReturnType<typeof getEmailNotifications>>,
  TError = ErrorType<unknown>,
>(
  orderId: string,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getEmailNotifications>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetEmailNotificationsQueryKey(orderId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getEmailNotifications>>
  > = ({ signal }) =>
    getEmailNotifications(orderId, { signal, ...requestOptions });
...
export type GetEmailNotificationsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getEmailNotifications>>
>;
